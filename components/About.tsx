        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-gray-900/50 p-8 rounded-2xl backdrop-blur-sm">
            <p className="text-lg mb-6 text-gray-300">
              Soy ingeniera de software con 5 años de experiencia en el desarrollo de aplicaciones web.
              Me especializo en Java, Spring Boot, Angular y Typescript, y me apasiona crear soluciones eficientes,
